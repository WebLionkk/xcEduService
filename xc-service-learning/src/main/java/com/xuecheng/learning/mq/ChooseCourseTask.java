...
public class ChooseCourseTask {
    ...
    public void receiveChoosecourseTask(XcTask xcTask) throws Exception {
        ...
        ResponseResult addcourse = courseLearningService.addcourse(userId, courseId, valid, startTime, endTime, xcTask);
